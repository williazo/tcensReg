...
#' @param a Numeric scalar defining the common left-truncation value for each Truncated Normal
...
#' @param b Numeric scalar defining the common right-truncation value for each Truncated Normal
...
#' @keywords internal
tcensReg_llike_sepvar <- function(theta,
                                  y,
                                  X,
                                  group,
                                  a = -Inf,

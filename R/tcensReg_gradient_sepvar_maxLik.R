...
#' @param left_trunc Numeric scalar indicating the left-truncation value
#' @param v Numeric scalar indicating the left-censoring value
#' @param xi Numeric scalar indicating the right-censoring value
#' @param right_trunc Numeric scalar indicating the right-truncation value
...
tcensReg_gradient_sepvar_maxLik <- function(theta,
                                            y,
                                            X,
                                            group,
                                            left_trunc = -Inf,

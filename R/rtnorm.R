...
#'
#' @details Note that if the mean \code{mu} is specified as a vector then the standard deviation
...
#'
#' @return Returns a vector of samples drawn from the specified distribition eqaul to length n.
#'
#' @export
